...
return_dict = {}
fls = cgi.FieldStorage()

class PostHandler(CGIHTTPRequestHandler):
  	
    def getValues(jsonList):
        ...
        return_dict = dict(zip(keys, result_probs))
    ...
    def do_POST(self):
        ...
        json_list = self.rfile.read(content_length)
        self.wfile.write(getValues(json_list))
